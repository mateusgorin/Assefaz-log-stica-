          ...
          <div className={`relative bg-white w-full max-w-sm p-8 shadow-2xl border-t-8 ${theme.border} animate-in zoom-in duration-200`}>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Novo Saldo em Estoque</label>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button 
                  onClick={() => setEditingProduct(null)}
                  disabled={isSaving}
                  className="py-3 bg-slate-100 text-slate-600 text-[10px] font-bold uppercase tracking-widest hover:bg-slate-200 transition-colors disabled:opacity-50"
                >
                  Cancelar
                </button>
                <button 
                  ...
                  disabled={isSaving}
                  className={`py-3 ${theme.accent} text-white text-[10px] font-bold uppercase tracking-widest hover:opacity-90 transition-all flex items-center justify-center gap-2 disabled:opacity-50`}
                >
